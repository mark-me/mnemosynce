...
The Gmail password field expects a 16-character **app password**, not your
regular Google account password. If you have not generated one yet, see the
[Gmail app password](gmail-app-password.md) guide before proceeding with this
step.
